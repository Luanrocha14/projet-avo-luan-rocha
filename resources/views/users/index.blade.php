                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#viewUserModal" data-user='@json($user)'>
                                    <i class="bi bi-eye"></i>
                                </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            viewModal.addEventListener('show.bs.modal', function(event) {
                ...
                document.getElementById('userCreated').textContent = new Date(user.created_at)
                    .toLocaleString('pt-BR');
                document.getElementById('userUpdated').textContent = new Date(user.updated_at)
                    .toLocaleString('pt-BR');
            });
            ...
            deleteModal.addEventListener('show.bs.modal', function(event) {
                ...
                // ✅ Corrigido: agora aponta para a rota certa
                const action = "{{ route('user.destroy', ':id') }}".replace(':id', userId);
